...
<audio id="policia">
  <source src="{{ asset('audio/policia.mp3') }}" type="audio/mpeg">
</audio>
        ...
        <div class="modal-content" id="app">
            ...
            <div class="modal-body" id="modal_police" style="display: none;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick='document.getElementById("policia").pause()' id="closePolice" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
...
<div class="alert alert-success" role="alert" id="alert_sensor_actived" style="display: none;">
  Has activado la alarma...  ha faltado poco.
...
channel.bind('notify-event', function(message) { 
        ...
        let soundPolicia = document.getElementById("policia");
        soundPolicia.currentTime = 0;
        soundPolicia.loop = true;
