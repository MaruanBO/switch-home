                                ...
                                <br>
                                  <li class="nav-item dropdown" style="">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-header" href="{{ route('maskAll') }}" style="float: right;">Marcar todos</a>
                                          ...
                                          <div class="dropdown-divider"></div>
                                            ...
                                            @if(Auth::user()->unreadNotifications->count())
                                              ...
                                              @foreach ( Auth::user()->unreadNotifications as $notification)
                                                  ...
                                                  <p class="dropdown-item" style="background: none;border: none; color:black;">
                                                       ...
                                                       <small><strong style="color:#5900de">{{$notification->data['user_email']}}</strong></small><br>
                                                      <small class="text-muted"><small>[{{$notification->id}}]</small><br>Enviado el {{$notification->updated_at}}</small><br><br>

                                                      <a href="{{ route('maskAsRead') }}" class="btn btn-outline-primary btn-block">
                                                        <i class="fas fa-comment-times"></i>
                                                      </a>
                                                      <a href="{{ route('maskDelete') }}" class="btn btn-outline-primary btn-block">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-header" href="{{ route('maskAllDelete') }}" style="float: right;">Eliminar todos</a>
